...
The following individual skills are deprecated in favor of `/release`:
- `planning-init` → `/release plan init`
- `release-preflight` → Part of `/release execute`
- `release-changelog` → Part of `/release execute`
- `release-tag` → Part of `/release execute`
- `release-publish` → Part of `/release execute`
- `release-verify` → Part of `/release execute`
- `release-housekeeping` → Part of `/release execute`

Individual skills remain available for targeted use.
