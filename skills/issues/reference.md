...
for repo in homestak-iac/ansible homestak/bare-metal homestak/bootstrap homestak-iac/iac-driver homestak-iac/packer homestak/config homestak-iac/tofu homestak-dev/.claude homestak-dev/.github homestak-dev/meta; do
  echo "=== $repo ==="
...
```bash
export HOMESTAK_REPOS="homestak-iac/ansible homestak/bare-metal homestak/bootstrap homestak-iac/iac-driver homestak-iac/packer homestak/config homestak-iac/tofu homestak-dev/.claude homestak-dev/.github homestak-dev/meta"
```
