...
for repo in homestak/bare-metal homestak/bootstrap homestak/config homestak-dev/.claude homestak-dev/.github homestak-dev/meta homestak-iac/ansible homestak-iac/iac-driver homestak-iac/packer homestak-iac/tofu; do
  echo "=== $repo ==="
...
```bash
export HOMESTAK_REPOS="homestak/bare-metal homestak/bootstrap homestak/config homestak-dev/.claude homestak-dev/.github homestak-dev/meta homestak-iac/ansible homestak-iac/iac-driver homestak-iac/packer homestak-iac/tofu"
```
